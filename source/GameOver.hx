...
class GameOver extends FlxState
{
	...
	override public function create():Void
	{
		...
		var gameOver:FlxText = new FlxText(0, FlxG.height / 2 - 100, FlxG.width, 'Game Over', 36);
		gameOver.alignment = FlxTextAlign.CENTER;
		gameOver.scrollFactor.set(0, 0);
		add(gameOver);
		
		var subTitle:FlxText = new FlxText(0, FlxG.height / 2 + 50, FlxG.width, 'You made it to level ${Config.currentLevel + 1}\nPress the left mouse button to return to menu', 20);
